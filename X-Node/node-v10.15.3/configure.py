...
shared_optgroup.add_option('--shared-spdlog',
                           action='store',
                           dest='shared_spdlog',
                           help='a directory to log all events in node.js')

shared_optgroup.add_option('--shared-spdlog-includes',
                           action='store',
                           dest='shared_spdlog_includes',
                           help='a directory to log all events in node.js')

shared_optgroup.add_option('--shared-spdlog-libname',
                           action='store',
                           dest='shared_spdlog_libname',
                           default='spdlog',
                           help='a directory to log all events in node.js')

shared_optgroup.add_option('--shared-spdlog-libpath',
                           action='store',
                           dest='shared_spdlog_libpath',
                           help='a directory to log all events in node.js')
...
configure_library('spdlog',output)
